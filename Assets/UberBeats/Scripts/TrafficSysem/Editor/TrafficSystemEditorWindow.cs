...
public class TrafficSystemEditorWindow : EditorWindow
   ...
   
  {
    ...
    void CreatePlayer()
    {
        GameObject carObject = new GameObject("Player" + waypointCount,typeof(Player));
        Selection.activeGameObject = carObject;
        carObject.transform.SetParent(TrafficSystem.transform.Find("PlayerPosition"),false);
        Selection.activeGameObject = carObject;
    ...
    void  AddPlayerPosition()
    {
        CreatePlayer();
        var carObj = Selection.activeGameObject;
        /*var playerWaypoint = carObj.GetComponent<Waypoint>();
